...
{
    public partial class ConsultarSelecao : Form
    {
        public ConsultarSelecao()
        {
            InitializeComponent();
        }

        private void Consultar_Emprestimo_Click(object sender, EventArgs e)
        {
            ConsultaEmprestimo consultaEmprestimo = new ConsultaEmprestimo();
            consultaEmprestimo.TopLevel = false;
